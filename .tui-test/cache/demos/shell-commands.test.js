//# hash=817458e46bc05e4ffb72a4b34175132c
...
test('demonstrate shell commands', function(param) {
        ...
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                ...
                case 1:
                    ...
                    return [
                        4,
                        expect(terminal.getByText('fspec.videos', {
                            full: true
                        })).toBeVisible({
                            timeout: 3000
                        })
                ...
                case 2:
                    ...
                    return [
                        4,
                        expect(terminal.getByText('package.json', {
                            full: true
                        })).toBeVisible({
                            timeout: 3000
                        })
