//# hash=d219af6277fcd962d440707e62103996
 ...
 */ export function specReviewDemo() {
    return _async_to_generator(function() {
        ...
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                ...
                case 17:
                    _state.sent(); // Show acceptance criteria (example)
                    return [
                        4,
                        delay(2500)
                    ];
                ...
                case 19:
                    _state.sent(); // Show work units (example)
                    return [
                        4,
                        delay(2000)
                    ];
...
if (import.meta.url === "file://".concat(process.argv[1])) {
    specReviewDemo().catch(function(error) {
