//# hash=5f8fd8304c49f4b10359c94a2d0e9382
 ...
 */ export function simpleTestDemo() {
        ...
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                ...
                case 6:
                    ...
                    return [
                        4,
                        controller.write('./dist/index.js list\n')
                    ];
                case 7:
                    _state.sent();
                    return [
                ...
                case 8:
                    ...
                    return [
                        4,
                        controller.write('./dist/index.js --help\n')
                    ];
                case 9:
                    _state.sent();
                    return [
                ...
                case 10:
                    ...
                    return [
                        4,
                        controller.write('echo "Valid options: width 100, height 30"\n')
                    ];
                case 11:
                    _state.sent();
                    return [
...
if (import.meta.url === "file://".concat(process.argv[1])) {
    simpleTestDemo().catch(function(error) {
