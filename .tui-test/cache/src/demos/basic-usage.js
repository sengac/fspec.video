//# hash=f2d7c2411e59bce86767f687a3501dd8
        ...
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                ...
                case 6:
                    ...
                    return [
                        4,
                        controller.write('\x1b')
                    ];
                case 7:
                    _state.sent(); // ESC to close help
...
if (import.meta.url === "file://".concat(process.argv[1])) {
    basicUsageDemo().catch(function(error) {
