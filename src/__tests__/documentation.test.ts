...
describe('Feature: Documentation', () => {
  ...
  describe('Scenario: README includes installation instructions', () => {
    it('should have Installation section with npm install', () => {
  ...
  describe('Scenario: README documents CLI commands with examples', () => {
    it('should document record and list commands with examples', () => {
  ...
  describe('Scenario: README documents configuration file format', () => {
    it('should document config file with examples', () => {
