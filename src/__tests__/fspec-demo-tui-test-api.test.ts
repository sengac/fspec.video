...
describe('Feature: Create fspec demo video using correct tui-test API', () => {
  describe('Scenario: Demo script uses correct tui-test API', () => {
    it('should use correct tui-test imports and structure', () => {
      // @step Given I have a demo script demos/fspec-demo.test.ts
      const demoPath = 'demos/fspec-demo.test.ts';
  ...
  describe('Scenario: Record fspec demo video with readable 4K output', () => {
    it('should produce readable 4K video file', () => {
      ...
      const videoPath = 'recordings/FINAL-FSPEC-DEMO.webm';
